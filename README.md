...
# Development
Project is **pre-alpha** and in an early development stage. At the moment we are working on a prototype.


# Related Work
Have a look at [BookWyrm](https://github.com/bookwyrm-social/bookwyrm)!


# License
All TestaPP-Software is open source and licensed under the [AGPL-3.0](LICENSE).

For more information see [Affero General Public License](docs/AGPL3.txt) or [GNU Licenses](https://gnu.org/licenses). 
